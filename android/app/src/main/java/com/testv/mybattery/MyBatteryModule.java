...
public class  MyBatteryModule extends ReactContextBaseJavaModule
  ...
  public MyBatteryModule(ReactApplicationContext reactApplicationContext) {
  ...
  class PowerConnectionReceiver extends BroadcastReceiver {
    private MyBatteryModule mBatteryModule;
